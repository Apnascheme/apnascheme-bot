...
app.post('/gupshup', async (req, res) => {
  try {
    ...
    if (type === 'message' && payload) {
      ...
      console.log('Message payload structure:', JSON.stringify(messagePayload, null, 2));
      ...
      console.log(`Message text lowercase: "${messageText.toLowerCase().trim()}"`);
      ...
      if (messageText.toLowerCase().trim() === 'hi') {
        ...
        console.log(`❌ Message "${messageText}" does not match "hi"`);
      }
    }
